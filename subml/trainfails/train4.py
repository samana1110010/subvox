...
def build_s_calibration_and_test():
    """
    For each S word:
    - randomly take S_CALIBRATION_RATIO windows for calibration/training
    - use remaining windows for testing

    This is better than first 50% vs last 50% because EMG drifts over time.
    """
    ...
    for word in WORDS:
        ...
        calib_idx = indices[:calib_n]
        test_idx = indices[calib_n:]
